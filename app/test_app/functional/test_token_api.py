...
def test_get_token(test_client, authed_stengo_admin_user, create_transfer_account_user):
...
def test_create_token(
        test_client, authed_stengo_admin_user, name, symbol, decimals, address, chain, tier, status_code
):
