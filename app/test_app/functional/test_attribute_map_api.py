...
def test_attribute_map_api(test_client, complete_admin_auth_token, authed_stengo_admin_user):
    ...
    assert attribute.organisation == authed_stengo_admin_user.default_organisation
