...
def send_transfer_update_email(email_address, transfer_info, latest_status):
    ...
    add_after_request_executor_job(ses_email_handler, [email_address, 'stengo: Transfer Update', textbody, htmlbody])
...
def send_bank_transfer_email(email_address, charge_info):
    ...
    add_after_request_executor_job(ses_email_handler, [email_address, 'stengo: Fund your wallet', textbody, htmlbody])
...
def send_invite_email(invite, organisation):
    ...
    add_after_request_executor_job(ses_email_handler, [invite.email, 'stengo: Invite to Join!', body])
...
def send_invite_email_to_existing_user(organisation, email_address):
    ...
    add_after_request_executor_job(ses_email_handler, [email_address, 'stengo: Added to new Organisation!', body])
...
def send_export_email(file_url, email_address):
    ...
    add_after_request_executor_job(ses_email_handler, [email_address, 'stengo: Your export is ready!', body])
...
def send_activation_email(activation_token, email_address):
    ...
    add_after_request_executor_job(ses_email_handler, [email_address, 'stengo: Activate your account', textbody, htmlbody])
